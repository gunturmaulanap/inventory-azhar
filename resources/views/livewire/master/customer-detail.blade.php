<div>
    ...
    <div x-data="{ open: false, display: 0 }">
        <div class="grid grid-cols-3 gap-x-4 w-full mb-4">
            ...
            <article class="flex items-center gap-4 rounded-lg border border-gray-100 bg-white p-6 sm:justify-between">
        ...
        <div class="flex items-center justify-between">
            <nav class="flex items-center mt-6">
                <button @click="display = 0"
                    ...
                    class="px-3 py-2 text-sm font-medium transition-all transition-colors">
                    Riwayat Transaksi
                </button>
                    ...
                    <div class="divide-y p-6">
                        ...
                        <div>
                            <div class="grid py-3 grid-cols-4 text-center mt-1">
                                ...
                                <dd class="text-gray-700 mr-4 col-span-1">@currency($customer->balance)</dd>
                            </div>
                            <div class="grid py-3 grid-cols-4 text-center items-center">
                                <dt class="font-medium text-gray-900 col-span-2">Nominal</dt>
                                <dd class="text-gray-700 mr-4 col-span-1">
                                    <div class="mt-2">
                            ...
                            <div class="grid py-3 grid-cols-4 text-center mt-1">
                                <dt class="font-medium text-gray-900 col-span-2">Total saldo</dt>
                                <dd class="text-gray-700 mr-4 col-span-1">@currency($customer->balance + ($balance ?? 0))</dd>
                            </div>
                        </div>
        ...
        <div x-show="display === 0" x-transition:enter.duration.700ms class="rounded-md border bg-white mt-6">
        ...
        <div x-show="display === 1" x-transition:enter.duration.700ms class="rounded-md border bg-white mt-6">
            <div class="relative w-full overflow-auto">
                <table class="w-full text-sm">
                    <thead>
                        <tr class="border-b">
